      ...
      <div className="relative">
        ...
        <div className="animate-float bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 max-w-sm shadow-2xl">
          <div className="text-center mb-6">
            ...
            <h3 className="font-display text-white text-xl font-bold">Your 7-Day Clarity Plan</h3>
            <p className="text-secondary/60 text-sm mt-1">Includes inside</p>
          </div>

          <ul className="space-y-3">
            {cardItems.map((item, i) => (
              <li key={i} className="flex items-center gap-3 text-secondary/80 text-sm">
                <span
          ...
          <div className="mt-6 pt-6 border-t border-white/10 flex justify-between items-center">
            <span className="text-secondary/50 text-sm line-through">Value: $97</span>
