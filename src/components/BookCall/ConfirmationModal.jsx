  ...
  return (
    ...
    >
      <div className="bg-white rounded-3xl p-10 max-w-md w-full text-center shadow-2xl animate-fade-up relative">
        ...
        <div
          className="w-20 h-20 rounded-full flex items-center justify-center text-4xl mx-auto mb-5 animate-float"
          style={{
        ...
        >
          ...
          <div className="text-gray-400 text-xs mt-1">30 minutes · Video or Phone</div>
        </div>
        ...
        <div className="text-xs text-gray-300 bg-secondary/20 rounded-xl px-4 py-3">
          📋 Booking ID:{" "}
          <span className="font-mono text-primary">{booking.id}</span>
        </div>
      </div>
    </div>
  );
